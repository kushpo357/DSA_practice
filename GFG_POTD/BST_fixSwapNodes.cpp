...
class Solution {
  public:
    ...
    void inorder(struct Node *&first, struct Node *root, struct Node *&second, struct Node *&prev)
    {
        
        if(root->left != NULL)
            inorder(first, root->left , second, prev);
        ...
        if(root->right != NULL)
                inorder(first, root->right , second, prev);
    }
    ...
    struct Node *correctBST(struct Node *root) {
        ...
        inorder(first, root, second, prev);
